...
\begin{document}
   ...
   \begin{frame}{Spielmodi - Binär-Select}
	...
	\centering
	\includegraphics[width=0.9\textwidth]{img/Klassendiagramm.png}
	\end{frame}
    ...
    \begin{frame}{Vorgehensweise}
        \only<1>{\includegraphics[width=1.15\textwidth]{img/WasserfallOhneRueckkopplung.png}}
        \only<2>{\includegraphics[width=1.15\textwidth]{img/Wasserfall.png}}
    \end{frame}
