...
Bereits während der Implementierung sind viele Unit-Tests entstanden. So haben wir mit den bisher vorhandenen 156 Unit-Tests eine Testüberdeckung von X Prozent erreicht, die in der Qualitätssicherungsphase noch optimiert wird. Aufgeteilt auf die größeren Pakete sind das:
\begin{itemize}
	\item User: Testüberdeckung 54 Prozent mit 16 einzelnen Unit-Tests
	\item Database: Testüberdeckung X Prozent mit 44 einzelnen Unit-Tests %TODO
	\item Game: Testüberdeckung 65 Prozent mit 45 einzelnen Unit-Tests
	\item Gamification: Testüberdeckung 96 Prozent mit 34 einzelnen Unit-Tests
	\item Configuration: Testüberdeckung 50 Prozent mit 10 einzelnen Unit-Tests
\end{itemize}
