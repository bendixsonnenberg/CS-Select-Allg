...
\begin{itemize}
    \item Erweiterte Nutzerverwaltung (E-Mail-Adresse und Passwort ändern, Passwort zurücksetzen wurde nicht implementiert)
\end{itemize}
...
\begin{itemize}
    ...
    \item ID wird nicht mehr gespeichert, immer in Echtzeit von Datanbank abgefragt
...
\begin{itemize}
    ...
    \item Bietet Möglichkeit, vor Spielerstellung eingeladene Emails zu entfernen
...
\chapter{Unit-Tests} %TODO Werte ändern
