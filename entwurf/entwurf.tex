...
\begin{document}
	...
	\subsection{AchievementReachScoreHundred}
	Dieses konkrete Achievement erhält ein Spieler, wenn er eine Gesamtpunktzahl von mindestens 100 Punkten erreicht. \\
	Hierfür wird das Singleton-Entwurfsmuster verwendet, damit nur ein Leaderboard-Objekt existert.

	\subsubsection{AchievementReachScoreHundred}
	\begin{itemize}
		\item Beschreibung: Der Konstruktor von AchievementReachScoreHundred setzt Namen und Beschreibung von AchievementReachScoreHundred.
	\end{itemize}
	\subsubsection{checkProgress}
	Hier Verweis?
	\subsubsection{getInstance}
	...
	\subsection{AchievementReachScoreThousand}
	Dieses konkrete Achievement erhält ein Spieler, wenn er eine Gesamtpunktzahl von mindestens 1000 Punkten erreicht. \\
	Hierfür wird das Singleton-Entwurfsmuster verwendet, damit nur ein Leaderboard-Objekt existert.

	\subsubsection{AchievementReachScoreThousand}
	\begin{itemize}
		\item Beschreibung: Der Konstruktor von AchievementReachScoreThousand setzt Namen und Beschreibung von AchievementReachScoreThousand.
	\end{itemize}
	\subsubsection{checkProgress}
	Hier Verweis?
	\subsubsection{getInstance}
