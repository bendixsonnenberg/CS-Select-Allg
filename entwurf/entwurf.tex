...
\begin{document}
	...
	Player stellt den Spieler im System dar. Diese Klasse erbt von der Nutzer-Klasse
		...
		\begin{itemize}
			\item Beschreibung: Subroutine zur indirekten Kommunikation mit der Datenbank. Dort wird der neue Spieler eingetragen (registriert)
			\item Parameter:
				\begin{itemize}
					\item String (Nutzername repräsentierend)
					\item String (Email repräsentierend)
	...
	\begin{comment} Das mit SVG funktioniert noch nicht, svg als pdf
	\section{Streak}
	%\label{fig:Streak_State}
	\includegraphics[width=\textwidth]{img/Streak_Zustand.svg}
	...
	\includegraphics[width=\textwidth]{img/Spiel_Zustand.svg}
	...
	\includegraphics[width=\textwidth]{img/Achievment_State.svg}
