...
\begin{document}
    ...
    \\
    Als weiteren Punkt beschreiben wir unsere Testüberdeckungswerte und wie diese erreicht wurden. Darüber hinaus erläutern wir noch unsere benutzten Testmetriken. \\
    \\
    ...
    \chapter{Testfälle}
        ...
        Die folgenden Szenarien sind alle dem Pflichtenheft entnommen. Sie sind mit dem deutschen Sprachpaket durchgeführt worden.
            ...
            \begin{itemize}
                ...
                \item Schritte:
                    \begin{itemize}
                        ...
                        \item Alle Pflichtfelder (d.h. Titel, Beschreibung, Spielmodus, Terminierung, Feature Set, Datenbankname) korrekt ausfüllen
            ...
            \begin{itemize}
                ...
                \item Schritte:
                    \begin{itemize}
                        \item Alle Pflichtfelder (d.h. Titel, Beschreibung, Spielmodus, Terminierung, Feature Set, Datenbankname) korrekt ausfüllen
                        \item Im Textfeld \enquote{Name der Vorlage} einen Name für die Vorlage auswählen, zuvor die Checkbox setzen
                        \item Auf \enquote{Erstellen} klicken
                    \end{itemize}
                \item Funktioniert: Ja
            \end{itemize}
            ...
            \begin{itemize}
                ...
                \item Schritte:
                    \begin{itemize}
                        \item Unter \enquote{Laufende Spiele} Spiel-Information auslesen
                    \end{itemize}
                \item Funktioniert: Ja
            \end{itemize}
            ...
            \begin{itemize}
                \item Ausgangssituation: Spieler ist angemeldet und hat offenes Spiel von Matrix Select
                \item Schritte:
                    \begin{itemize}
                        \item Auf Übersichts-Seite das entsprechende Spiel suchen und \enquote{Spielen} wählen
                        \item Bestimmte Merkmale auswählen (innerhalb der angegeben Reichweite), eventuell auch welche als nutzlos markieren oder Graphen anzeigen lassen
            ...
            \begin{itemize}
                \item Ausgangssituation: Spieler ist angemeldet und hat offenes Spiel von Binär Select
                \item Schritte:
                    \begin{itemize}
                        \item Auf Übersichts-Seite das entsprechende Spiel suchen und \enquote{Spielen} wählen
        ...
        Die folgenden Szenarien sind alle in der Qualitätssicherungphase entstanden und von uns erfunden. Sie sind ebenso mit dem deutschen Sprachpaket durchgeführt worden.
    ...
    \begin{itemize}
        ...
        \item Grund: Die neue Runde wurde noch nicht geladen, aber der Grpah eines Merkmals der letzten Runde wurde noch angezeigt
