...
\begin{document}
    ...
    \subsection{Merkmale für Spiel auswählen}
    ...
    \centering
    \includegraphics[width=\textwidth]{../pictures/1_Anmeldung.jpg}
    ...
    \centering
    \includegraphics[width=\textwidth]{../pictures/4_Spielerstellung.jpg}
    ...
    \subsection{Spiel}
    \centering
    \includegraphics[width=\textwidth]{../pictures/6_Spiel.jpg}
