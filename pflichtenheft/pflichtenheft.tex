...
description={Ein Server, der uns bereitgestellt wird und mit REST-API. Der ML-Server übernimmt das Machine Learning und stellt die Datensätze für das Spiel zur Verfügung. Die API kann mind. folgende 2 
    ...
    \item \texttt{GET /score} Bewertet eine Merkmalsauswahl eines Spielers. Gibt eine Zahl zwischen 0 und 1 zurück, was der Bewertung des Datensatzes entspricht. Parameter: Datensatzidentifier, ausgewählte Merkmale
    \end{itemize}}
}
...
\begin{document}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        ...
        /KA130/ & Der \Gls{Organisator} eines Spiels kann nach dem Beginn eines Spiels noch weitere Spieler einladen. \\
        ...
        /KA160/ & Für Spieler gibt es ein Punktsystem basierend auf den Spielergebnissen der Spiele. \\
 ...
 sind Spiele und Nutzer immer noch die selben. Man kann also ohne Sorge den Server neu starten.} \\
