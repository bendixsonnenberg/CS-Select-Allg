...
\begin{document}
    ...
    Hierfür wird ein Spiel für den Browser entwickelt, in dem Personen mit \Gls{Domänenwissen} Merkmale bewerten können.
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        ...
        /KA50/ & Der \Gls{Spiel-Server} kann vom Terminal aus beendet werden. \\
        ...
        /KA280/ & Der \Gls{Spiel-Server} behält seinen Zustand über das Stoppen und Starten hinweg.\footnote{Das heißt, wenn der Server beendet und danach wieder gestartet wird,
