...
\begin{document}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        ...
        /KA240/ & Es gibt ein GUI für \Glspl{Administrator}. \\ %Die oder der Gui? ^^
    \end{tabularx}
    ...
    (in \fref{chap:Spieler-Übersicht} gezeigt) kann der \Gls{Spieler} seine \Gls{Achievement}s einsehen.
