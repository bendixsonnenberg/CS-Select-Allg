...
\begin{document}
    ...
    \begin{itemize} %TODO: In diesem Absatz, Glossar Links
        ...
        \begin{itemize}
            \item Organisatoren erstellen Spiele 
            \item Spieler nehmen an Spielen teil 
 ...
 sind Spiele und Nutzer immer noch dieselben. Man kann also ohne Sorge den Server neustarten.} \\
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & Ein Organisator kann in der Spielerstellungs \\
    /F20/ & \\
    /F30/ & \\
    /F40/ & \\
    /F50/ & \\
    ...
    \section{Merkmalsauswahl während eines Spiels}
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & \\
    /F20/ & \\
    /F30/ & \\
    ...
    \section{GUI}
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & Nutzer haben Zugriff auf die Anmeldungs-GUI \\
    ...
    /F70/ & Nach Beenden des Spiels kehren Spieler auf die Spieler-Übersichts-GUI zurück \\
    ...
    \section{Verbesserung Merkmalsauswahl} %Optional
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & Registrierung \\
    /F20/ & \\
    /F30/ & \\
    ...
    \section{Bedienungshilfen} %Optional
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & Registrierung \\
    /F20/ & \\
    /F30/ & \\
    
    \section{Internationalisierung} %Optional
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & Registrierung \\
    /F20/ & \\
    /F30/ & \\
