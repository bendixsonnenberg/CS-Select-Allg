...
name=Spieler,
plural=Spieler,
description={Eine im System registrierte Person, welche an einem Spiel teilnimmt. Meist ist dies ein Angestellter des Betriebs}
}
...
name=Nutzer,
plural=Nutzer,
description={Alle \Glspl{Spieler} und \Glspl{Organisator}}
}
...
\begin{document}
   ...
   \subsection{Spieler registrieren}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \Gls{Spieler} klickt auf abmelden
 ...
 \subsection{Spielzustand auslesen}
    ...
    \begin{itemize}
        ...
        \item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, Spieler wurde von \Gls{Organisator} zu einem Spiel eingeladen, \Gls{Spieler} ist angemeldet
