...
\begin{document}
    ...
    \begin{tabular}{ l | l}
        ...
        /FA110/ & Das System muss mit dem \Gls{ML-Server} kommunizieren. \\ %Einheitliche Schreibweise ML-Server
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        ...
        /KA280/ & Der \Gls{Spiele-Server} behält seinen Zustand über das Stoppen und Starten hinweg.\footnote{Das heißt, wenn der Server beendet und anschließend wieder gestartet wird,
 sind Spiele und Nutzer immer noch dieselben. Man kann also ohne Sorge den Server neustarten.} \\
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}}
        ...
        \begin{itemize}
              \item E-Mail-Adresse, Nutzername, Punktestand, Rolle, Passwort (als Hash)
        \end{itemize} \\
...
\newpage
    ...
    \subsection{Achievments Zustandsdiagramm}
