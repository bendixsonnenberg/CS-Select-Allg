...
\begin{document}
    ...
    \hypertarget{F590}{/F590/} & Rundendaten\footnote{Ausgewählte Merkmale, Spielername, Zeitpunkt, Rundenanzahl, Vorhersagequalität, Punkte} werden in der vom Organisator ausgewählten Datenbank gespeichert \\ %Datenbank zu Spiel
    \end{tabularx}
 ...
 \subsection{Spielzustand auslesen}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \Gls{Spieler} bestätigt seine Auswahl
			\item System schickt ausgewähltes \Glspl{Merkmal} an \Gls{ML-Server}
			\item \Gls{ML-Server} bewertet Auswahl und schickt Ergebnis zurück
		\end{itemize}
