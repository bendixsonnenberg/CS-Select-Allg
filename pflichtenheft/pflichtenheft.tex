...
name=Binär Select,
plural=Binär Select,
description={Binär Select ist ein \Gls{Spielmodus}, in dem ein \Gls{Spieler} genau zwei Merkmale angezeigt bekommt, diese vergleicht und das Merkmal auswählt, welches für das Machine-Learning-Modell wichtiger ist. Eine Runde besteht aus fünf Vergleichen}
}
...
description={Einstellungen für ein \Gls{Spiel} umfassen: die Merkmale, welche ausgewählt werden soll, die Art des Spiels, die teilnehmenden Spieler, Endbedingungen des Spiels}
}
...
description={Die Person, welche das System installiert und den Nutzern zur Verfügung stellt. Sie verwaltet den \Gls{Spiel-Server}. Jede Person mit Zugang zu dem Computer, auf dem der \Gls{Spiel-Server} läuft hat Administrator-Rechte}
}
...
description={Ein Server, der nicht Bestandteil des Produkts ist, jedoch benötigt wird, um die Funktionalität des Produktes herzustellen}
}
...
{
name=Domänenwissen,
description={Wissen, das sich direkt auf die mit Hilfe unseres Produkts zu optimierenden Prozesse bezieht.
Das Domänenwissen liegt oft bei den Mitarbeitern bzw. Personen, die sich täglich mit konkreten Problemen, die eine solche Vorhersage beeinflussen, in auseinandersetzen}
}
...
\begin{document}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} 
	/F30/ & Bei Start des Systems gibt es ein Dialog zur Einrichtung \\ %Explizit: Was kann man da machen?
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} 
	/F70/ & Erstregistrierung des \Gls{Organisator}s mit E-Mail und global gesetztem Passwort \\ %Machen wir das so?
	...
	/F380/ & \Gls{Organisator} kann sich über aktuellen Status seines Spiels informieren \\ %Genauer? Gespielte Runden einsehen und so?
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}}
    	...
    	/F470/ & \Gls{Spieler} kann maximal x Merkmale auswählen \\ % Wie viele Merkmale maximal? Gibt es Obergrenze?
    	/F480/ & \Gls{Spieler} muss bestätigen, dafür muss er genau/maximal x Merkmale ausgewählt haben \\ %Wie viele?
    \end{tabularx}
	...
	\begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        /F515/ & Spiele können gelöscht werden
	\end{tabularx}
    ...
    /F570/ & Rückmeldung wird in Rundenpunktzahl /Fxxx/ umgewandelt \\ %Wie? Das wird bei Punktesystem erklärt
	...
	/F720/ & Auflistung der Achievements aus /F20/ \\ %in der GUI?
	...
	/F770/ & Hilfe Schaltfläche im Spieler-GUI \\ %Die beiden erklären?
	/F780/ & Wenn der Nutzer mit dem Mauszeiger auf einer Schaltfläche im GUI verweilt, erscheint ein Tooltip \\ %Glossar
	\end{tabularx}
   ...
   \subsection{Spieler registrieren}
    ...
    \begin{itemize}
        ...
        \item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, Spieler ist registriert
    ...
    \begin{comment} %% steht auch nicht in den anforderungen
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}, \Gls{Spieler}
        \item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, \Gls{Spiel} ist gestartet
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}, \Gls{Spieler}
        \item Eingangsbedingungen: \Gls{Spiel} ist aktiv und gestartet
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}
        \item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, es existiert bereits ein Spiel
 ...
 \subsection{Spielzustand auslesen}
    ...
    \begin{itemize}
    	...
    	\item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, Spieler hat offenes \Gls{Spiel} des \Gls{Spielmodus} Matrix Select, \Gls{Spieler} ist angemeldet
        \item Ausgangsaktion: System gibt Spieler die erreichten Punkte an
    	\item Ereignisfluss:
    	\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \Gls{Spieler} klickt auf Schaltfläche, um Auswahl zu bestätigen
            \item Wiederhole Ereignisfluss 5 mal
		\end{itemize}
	...
	\begin{itemize}
		\item Teilnehmende Akteure: \Gls{Spieler}
		\item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, \Gls{Spieler} hat offenes Spiel
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Spieler}, \Gls{Organisator}
        \item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv, \Gls{Spieler} oder \Gls{Organisator} ist nicht angemeldet
        \item Ereignisfluss:
        \begin{itemize}
            \item \Gls{Organisator} oder \Gls{Spieler} klickt in Anmelde-GUI auf \enquote{Passwort zurücksetzen}
