...
\begin{document}
	...
	\hypertarget{F20}{/F20/} & Globales Passwort für \Glspl{Organisator} muss in /F10/ setzbar sein \\
    \hypertarget{F25}{/F25/} & \Gls{ML-Server} muss in /F10/ setzbar sein
    \end{tabularx}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} 
	\hypertarget{F70}{/F70/} & Erstregistrierung des \Gls{Organisator}s mit E-Mail und dem in /F20/ global gesetztem Passwort \\
    ...
    \hypertarget{F180}{/F180/} & Falls in /F170/ \Gls{Matrix Select} ausgewählt ist, muss \Gls{Organisator} Matrixgröße angeben \\
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}}
    \hypertarget{F250}{/F250/} & \Gls{Organisator} kann seine \Gls{Spieleinstellungen} aus /F170/-/F220/ speichern \\
    \hypertarget{F260}{/F260/} & \Gls{Organisator} kann seine gespeicherten \Gls{Spieleinstellungen} aus /F250/ laden und für neue Spielerstellung verwenden\\
	...
	\hypertarget{F360}{/F360/} & Ein \Gls{Spiel} terminiert nach Erreichen seiner Endbedingungen aus /F220/, danach kann keine Runde mehr gespielt werden \\
    ...
    \hypertarget{F390}{/F390/} & \Gls{Organisator} sieht in /F380/ gespielte Anzahl an bisherigen Runden
    \end{tabularx}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}}
    	...
    	\hypertarget{F460}{/F460/} & Genau die Anzahl an \Glspl{Merkmal}n, die der \Gls{Organisator} in /F180/ ausgewählt hat, werden angezeigt \\
	...
	\begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}}
		\hypertarget{F520}{/F520/} & Die dem \Gls{Spieler} angezeigten \Glspl{Merkmal} in /F410/ und /F450/ werden nicht zufällig ausgewählt \\
    ...
    \hypertarget{F550}{/F550/} & Bei \Gls{Matrix Select} wird in /F540/ die ausgewählte Teilmenge der Vergleiche geschickt \\
    \hypertarget{F560}{/F560/} & Bei \Gls{Binar Select} wird in /F540/ eine gebündelte Menge der Vergleiche geschickt \\
    \hypertarget{F570}{/F570/} & Rückmeldung des \Gls{ML-Server}s wird in Rundenpunktzahl (s. /F690/) umgewandelt \\ %Wie? Das wird bei Punktesystem erklärt
    ...
    \hypertarget{F660}{/F660/} & Nach Beenden der Runde kehren \Gls{Spieler} entweder auf die Spieler-Übersichts-GUI oder die Spiel-GUI zurück, je nach Auswahl in /F350/ \\
	...
	\hypertarget{F720}{/F720/} & Auflistung der \Glspl{Achievement} aus /F20/ in Spieler-GUI \\ %in der GUI?
	...
	\hypertarget{F750}{/F750/} & Erweitertes Punktesystem: Abschließen von /F710/ gibt je nach Schwierigkeitsgrad der Aufgabe zusätzliche Punkte \\
    \end{tabularx}
