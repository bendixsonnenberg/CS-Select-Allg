...
\begin{document}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} 
	/F120/ & Änderung der E-Mail von Nutzern \\
	/F130/ & Änderung des Passworts von Nutzern \\
	/F140/ & Zurücksetzen des Passworts von Nutzern ohne Kenntnis des derzeitigen Passworts \\
    \end{tabularx}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}}
    	...
    	/F470/ & \Gls{Spieler} kann eine Teilmenge an Merkmale auswählen, jedoch mindestens eines \\ % Wie viele Merkmale maximal? Gibt es Obergrenze?
    	/F480/ & \Gls{Spieler} muss bestätigen, dafür muss er mindestens ein Merkmal ausgewählt haben \\
    \end{tabularx}
	...
	/NF30/ & Die Anmeldedauer darf nicht mehr als zwei Sekunden betragen. \\
        /NF40/ & Ein Spieler soll das Ergebnis seiner gespielten Runde innerhalb von zwei Sekunden erhalten. \\
