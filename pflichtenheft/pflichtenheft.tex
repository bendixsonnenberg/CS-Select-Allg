...
\begin{document}
	...
	\item Grafische Benutzeroberflächen für Anwender 
        ...
        \item Zwei Spielmodi 
        \begin{itemize}
            \item Matrix Select: Spieler erhält mehrere Merkmale und wählt eine Teilmenge davon aus %Später dazu mehr irgendwie dazu?
 ...
 sind Spiele und Nutzer immer noch dieselben. Man kann also ohne Sorge den Server neustarten.} \\
	...
	/F30/ & Erstregistrierung eines Spielers mit Passwort, dass er in einer Einladungs-E-Mail erhalten hat \\ 
	/F40/ & Anmelden eines Spielers mit E-Mail und Passwort \\
    \end{tabularx}
	...
	/F40/ & Spieler sieht aktuelle Runde und Punktestand \\
    \end{tabularx}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
    /F10/ & Punktesystem für Spieler basierend auf ihren Eingaben, der erhaltene Wert des ML-Servers wird mit 100 multipliziert und 
    auf nächstgrößere ganze Zahl aufgerundet \\
    /F20/ & \\
    \end{tabularx}
