...
\begin{document}
   ...
   \subsection{Spieler registrieren}
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}, \Gls{Spieler}
        \item Eingangsbedingungen: \Gls{Spiel-Server} ist aktiv und Spiel läuft
 ...
 \subsection{Spielzustand auslesen}
    ...
    \begin{itemize}
    	\item Teilnehmende Akteure: \Gls{Spieler}
    	\item Eingangsbedingungen: Spiel-Server ist aktiv, Spieler hat offenes Spiel des \Gls{Spielmodus} Matrix Select. \Gls{Spieler} ist angemeldet
	...
	\begin{itemize}
		\item Teilnehmende Akteure: \Gls{Spieler}
		\item Eingangsbedingungen: Spiel-Server ist aktiv, \Gls{Spieler} hat offenes Spiel des \Gls{Spielmodus} Binär Select, \Gls{Spieler} ist angemeldet
        \item Ausgangsaktion: System gibt Spieler die erreichten Punkte an
		\item Ereignisfluss:
		\begin{itemize}
			\item \Gls{Spieler} klickt auf ein Merkmal und sieht Merkmalsgraphen und Merkmalsbeschreibung
