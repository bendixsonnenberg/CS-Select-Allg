...
\begin{document}
 ...
 sind Spiele und Nutzer immer noch dieselben. Man kann also ohne Sorge den Server neustarten.} \\
    ...
    Der Organisator möchte eine Verbesserung der Machine-Learning Prozesse erreichen, indem er das \Gls{Domanenwissen} der Spieler nutzt.
    Die Spieler tragen durch Spielen des \Gls{Produkt}s mit ihrem \Gls{Domanenwissen} zur besseren Merkmalsauswahl bei.
