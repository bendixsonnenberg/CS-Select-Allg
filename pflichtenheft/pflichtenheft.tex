...
{
    name=Datensatz,
    description={Die Menge an Features, die ein Machine Learning Model zur Verfügung hat. Zu jedem Feature gehört noch eine Beschreibung und zwei Bilder.}
}
\begin{document}
    ...
    \chapter{Einleitung}
        ...
        Das sogennante Domänenwissen liegt oft bei den Personen, welche den gesamten Tag z.B. an der Produktionslinie verbringen. Einige der Merkmale sind vielleicht offensichtlich nutzlos
        ...
        \\
        Der Name \texttt{CS:Select} bedeutet: \textbf{C}rowd \textbf{S}ourcing\textbf{:Select}, wobei das Select auf die Merkmalsauswahl (engl. Feature Select) anspielt und CS auf die bekannte
