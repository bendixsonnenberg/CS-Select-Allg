...
\begin{document}
    ...
    \begin{tabular}{ l | l}
        ...
        /KA240/ & Es gibt mindestens zwei Spielmodi: \Gls{Matrix Select} und \Gls{Binar Select}. \\
    \end{tabular}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        ...
        /KA250/ & Es gibt eine GUI für \Glspl{Administrator}. \\
        /KA260/ & Ein Spieler oder Organisator kann sein Passwort ändern. \\
        /KA270/ & Ein Spieler oder Organisator kann sein Passwort zurücksetzen. \\
        /KA280/ & In jedem Spiel wird eine Kombination an Features nur genau ein mal abgefragt.\\
    \end{tabularx}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Die Punkte des entsprechenden Spielers werden zruückgesetzt
        \end{itemize}
    \end{itemize}
