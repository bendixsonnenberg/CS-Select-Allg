...
\begin{document}
 ...
 sind Spiele und Nutzer immer noch dieselben. Man kann also ohne Sorge den Server neustarten.} \\
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} 
	/F10/ & Erstregistrierung des \Gls{Organisator}s durch global gesetztes Passwort \\ %Machen wir das so?
	...
	/F60/ & \Gls{Organisator} kann sich über aktuellen seines Spiels informieren \\ %Genauer? Gespielte Runden einsehen und so?
    ...
    \end{tabularx}
    \subsection{Optional: Matrix Select}
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} % Linebreaks in der Tabelle
        /F10/ & Die Auswahl der anzuzeigenden Merkmale ist nicht zufällig, sondern jedes Feature wird in etwa gleich häufig angezeigt.\\
        /F20/ & \Gls{Spieler} erhält weniger Punkte je mehr Merkmale er auswählt. \\    
\end{tabularx}
