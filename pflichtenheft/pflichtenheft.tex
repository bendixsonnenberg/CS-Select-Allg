...
name=Webbrowser,
plural=Webbrowser,
description={Computerprogramm zur Darstellung von Webseiten. Für dieses Produkt wird nur auf Google Chrome und Mozilla Firefox hin entwickelt}
}
...
description={Siehe \fref{sec:Matrix}}
}
\newglossaryentry{Binar Select}
{
name=Binär Select,
plural=Binär Select,
description={Siehe \fref{sec:Binar}}
}
...
description={Die Person die das System installiert und den \Glspl{Nutzer}n zur Verfügung stellt. Sie verwaltet den \Gls{Spiel-Server}. Jede Person mit Zugang zu dem Computer, auf dem der \Gls{Spiel-Server} läuft, hat Administrator-Rechte}
}
...
\begin{document}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l@{\hspace{.5em}}X@{}} 
	\hypertarget{F30}{/F30/} & Beim Start des Systems gibt es einen Dialog zur einfacheren Einrichtung \\ %Explizit: Was kann man da machen?
    ...
    \hypertarget{F280}{/F280/} & \Gls{Spieler} erhalten über die Spieler-GUI eine Benachrichtigung, dass sie eingeladen wurden \\ %Per Mail auch?
	\end{tabularx}
	...
	\hypertarget{F380}{/F380/} & \Gls{Organisator} kann sich über den aktuellen Status seines \Gls{Spiel}s informieren \\ %Genauer? Gespielte Runden einsehen und so?
    ...
    \hypertarget{F570}{/F570/} & Rückmeldung des \Gls{ML-Server}s wird in eine Rundenpunktzahl (s. \hyperlink{F690}{/F690/)} umgewandelt \\ %Wie? Das wird bei Punktesystem erklärt
    \hypertarget{F580}{/F580/} & Rundenpunktzahl wird zur Gesamtpunktzahl des \Gls{Spieler}s addiert \\
    \hypertarget{F590}{/F590/} & Rundendaten\footnote{Ausgewählte Merkmale, Spielername, Zeitpunkt, Rundenanzahl, Vorhersagequalität, Punkte} werden in der vom \Gls{Organisator} für das Spiel ausgewählten Datenbank gespeichert \\
    \hypertarget{F595}{/F595/} & Vom \Gls{Spieler} während einer Runde als unwichtig markierte \Glspl{Merkmal} (s. \hyperlink{F510}{/F510/)} werden bei Bestätigung der Auswahl in der vom \Gls{Organisator} für das Spiel ausgewählten Datenbank gespeichert \\
    \end{tabularx}
	...
	\hypertarget{F780}{/F780/} & Wenn der \Gls{Nutzer} mit dem Mauszeiger auf einer Schaltfläche in der GUI verweilt, erscheint ein Tooltip \\ %Glossar
	\end{tabularx}
   ...
   \subsection{Spieler registrieren}
    ...
    \begin{itemize}
        ...
        \item Ereignisfluss:
        \begin{itemize}
            \item \Gls{Organisator} wählt über seine GUI das zu löschende beendete Spiel
            \item \Gls{Organisator} bestätigt seine Auswahl
        \end{itemize}
 ...
 \subsection{Spielzustand auslesen}
    ...
    \begin{itemize}
    	\item Teilnehmende Akteure: \Gls{Spieler}, \Gls{ML-Server}
		...
		\item System schickt ausgewählte \Glspl{Merkmal} an \Gls{ML-Server}
		\item \Gls{ML-Server} bewertet Auswahl und schickt Ergebnis zurück
		\item System berechnet Punkte
    	...
    	\end{itemize}
        \item Anforderungen: \hyperlink{F320}{/F320/}, \hyperlink{F330}{/F330/}, \hyperlink{F350}{/F350/}, \hyperlink{F400}{/F400/} - \hyperlink{F430}{/F430/}, \hyperlink{F540}{/F540/} - \hyperlink{F590}{/F590/}, \hyperlink{F660}{/F660/}, \hyperlink{F680}{/F680/}, \hyperlink{F690}{/F690/} 
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \Gls{Spieler} klickt auf Schaltfläche um Auswahl zu bestätigen
            		\item Wiederhole Ereignisfluss fünf Mal, anschließend:
	    		\item System schickt alle ausgewählten \Glspl{Merkmal} an \Gls{ML-Server}
			\item \Gls{ML-Server} bewertet Auswahl und schickt Ergebnis zurück
			\item System berechnet Punkte
		\end{itemize}
        \item Anforderungen:\hyperlink{F320}{/F320/} - \hyperlink{F340}{/F340/}, \hyperlink{F440}{/F440/} - \hyperlink{F480}{/F480/}, \hyperlink{F540}{/F540/} - \hyperlink{F590}{/F590/}, \hyperlink{F680}{/F680/}, \hyperlink{F690}{/F690/}
	\end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item System schickt ausgewähltes \Gls{Merkmal} an \Gls{ML-Server}
			\item \Gls{ML-Server} bewertet Auswahl und schickt Ergebnis zurück
	...
	\begin{itemize}
		...
		\item Ausgangsaktionen: System gibt dem \Gls{Spieler} die erreichte Punktzahl an
		\item Ereignisfluss:
		\begin{itemize}
			...
			\item \Gls{Spieler} bestätigt seine Auswahl
			\item System schickt ausgewähltes \Gls{Merkmal} an \Gls{ML-Server}
			\item \Gls{ML-Server} bewertet\footnote{Als unwichtig markierte \Glspl{Merkmal} haben keinen Einfluss auf die Bewertung der Auswahl} Auswahl und schickt Ergebnis zurück
            \item Markiertes \Gls{Merkmal} wird in der Datenbank gespeichert
		\end{itemize}
		\item Anforderungen: \hyperlink{F510}{/F510/}, \hyperlink{F595}{/F595/}
	\end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \Gls{Organisator} oder \Gls{Spieler} bestätigt seine Auswahl
		\end{itemize}
		\item Anforderungen: \hyperlink{F120}{/F120/}
	\end{itemize}
