...
\begin{document}
   ...
   \subsection{Spieler registrieren}
    ...
    \begin{itemize}
        ...
        \item Eingangsaktionen: Spiel-Server ist aktiv, Organisator-Registrierungspasswort ist gesetzt
        \item Ereignisfluss:
        \begin{itemize}
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}, \Gls{Spieler}
        \item Eingangsaktionen: Spiel-Server ist aktiv, Spiel ist gestartet
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}
        \item Eingangsaktionen: Spiel-Server ist aktiv, es existiert bereits ein Spiel
    ...
    \begin{itemize}
        \item Teilnehmende Akteure: \Gls{Organisator}
        \item Eingangsaktionen: Spiel-Server ist aktiv, \Gls{Spieleinstellungen} wurden bereits gespeichert
 ...
 \subsection{Spielzustand auslesen}
    ...
    \begin{itemize}
    	\item Teilnehmende Akteure: \Gls{Spieler}
    	\item Eingangsaktionen: Spiel-Server ist aktiv, Spieler hat offenes Spiel des \Gls{Spielmodus} Matrix Select
    	\item Ereignisfluss:
    	\begin{itemize}
	...
	\begin{itemize}
		\item Teilnehmende Akteure: \Gls{Spieler}
		\item Eingangsaktionen: Spiel-Server ist aktiv, \Gls{Spieler} hat offenes Spiel des \Gls{Spielmodus} Binär Select
		\item Ereignisfluss:
		\begin{itemize}
			\item \Gls{Spieler} meldet sich an
			\item \Gls{Spieler} erreicht seine Übersichtsseite
	...
	\begin{itemize}
		\item Teilnehmende Akteure: \Gls{Spieler}
		\item Eingangsaktionen: Spiel-Server ist aktiv, \Gls{Spieler} hat offenes Spiel
...
\newpage
    ...
    Die Zustände, die ein Achievement von \enquote{Spieler kennt das Achievement nicht} bis zu \enquote{Spieler hat das Achievement erreicht}.
    \begin{itemize}
    \item Nicht sichtbar: Spieler weiß nicht, dass das Achievment existiert.
    \item Verdeckt: Spieler weiß, dass dieses Achievement existiert, aber weiß nicht, was er tun muss, um es zu erreichen.
